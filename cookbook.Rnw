...
<body>
    <div id="wrap">
      ...
      <div id="main">
            ...
            <ul>
              ...
              <table width="100%">
                <tbody>
                  ...
                  <tr>
                    <td><a href="downloads/v1.1.1/cummeRbund_1.1.1.tar.gz" onClick="recordOutboundLink(this, 'Downloads from BioC', 'Source');return false;">&nbsp;&nbsp;&nbsp;Package Source</a></td>
                  </tr>
                  <tr>
                    <td><a href="downloads/v1.1.1/cummeRbund_1.1.1.tgz" onClick="recordOutboundLink(this, 'Downloads from BioC', 'Mac OS X');return false;">&nbsp;&nbsp;&nbsp;Mac OS X binary</a></td>
                  </tr>
                  <tr>
                    <td><a href="downloads/v1.1.1/cummeRbund_1.1.1.zip" onClick="recordOutboundLink(this, 'Downloads from BioC', 'Windows');return false;">&nbsp;&nbsp;&nbsp;Windows binary</a></td>
                  </tr>
                </tbody>
              </table>
        ...
        <h2>Recipies</h2>
        <p>We are in the process of creating sample scripts here for advanced cummeRbunding.</p>
        <!-- InstanceEndEditable -->
        </div>
        </div>
      <div id="footer">
