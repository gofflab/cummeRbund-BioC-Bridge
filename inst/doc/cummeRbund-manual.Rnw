...
@
	...
	\includegraphics[width=0.4\textwidth]{cummeRbund-manual-global_plots_scatter_1}}
	\end{center}
\end{figure}
...
print(v)
@
		\includegraphics[width=0.4\textwidth]{cummeRbund-manual-global_plots_volcano_1}}
	\end{center}
\end{figure}
