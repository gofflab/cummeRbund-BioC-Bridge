...
s<-csScatter(cuff@genes,"hESC","Fibroblasts",smooth=T)
s
@
...
v<-csVolcano(cuff@genes,"hESC","Fibroblasts")
v
@
...
ih<-csHeatmap(myGenes@isoforms,cluster='both',labRow=F)
ih
@
...
@
\end{center}
\caption{Basic k-means clustering of a CuffGeneSet set of 20 random genes.}
\end{figure}
