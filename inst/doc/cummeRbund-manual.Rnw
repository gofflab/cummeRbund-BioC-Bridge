...
\subsection{CuffFeature Class}
	...
	\begin{itemize}
		...
		\item repFpkm: A data frame of deconvolved FPRKM values across all replicates for a given feature.
...
<<label=global_plots_dens_rep,fig=TRUE,echo=FALSE>>=
print(densRep)
@
...
<<label=global_plots_box_rep,fig=TRUE,echo=FALSE>>=
print(brep)
@
